...
var _LoginOrStart = __webpack_require__(57);

var _LoginOrStart2 = _interopRequireDefault(_LoginOrStart);

var _UserCreation = __webpack_require__(104);

var _UserCreation2 = _interopRequireDefault(_UserCreation);

var _DateCreation = __webpack_require__(105);

var _DateCreation2 = _interopRequireDefault(_DateCreation);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'updateComplete',
    value: function updateComplete() {
      this.setState({ userComplete: true });
    }
  }, {
    key: 'updateLogin',
    value: function updateLogin(logincheck) {
      var that = this;
      that.setState({
    ...
    key: 'updateUser',
    value: function updateUser(foundUser) {
      var that = this;
      that.setState({
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render(props) {
                return _react2.default.createElement(_LoginOrStart2.default, {
                  updateLogin: _this2.updateLogin,
                  updateUser: _this2.updateUser,
                  userLogged: _this2.state.userLogged,
                  serverResponded: _this2.state.serverResponded,
                  userComplete: _this2.state.userComplete,
                  username: _this2.state.username
                });
              } }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/userCreation', render: function render(props) {
                return _react2.default.createElement(_UserCreation2.default, {
                  updateComplete: _this2.updateComplete
                });
              } }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/dateCreation', render: function render(props) {
                return _react2.default.createElement(_DateCreation2.default, null);
              } })
          )
        )
      );
...
var appName = 'Safe Dates';

var LoginOrStart = function (_React$Component) {
  _inherits(LoginOrStart, _React$Component);

  function LoginOrStart(props) {
    _classCallCheck(this, LoginOrStart);

    return _possibleConstructorReturn(this, (LoginOrStart.__proto__ || Object.getPrototypeOf(LoginOrStart)).call(this, props));
  }

  _createClass(LoginOrStart, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var that = this;
      _axios2.default.get('/api/loggedin').then(function (logincheck) {
    ...
    value: function render() {
      ...
      if (this.props.userLogged === false && this.props.serverResponded === true) {
        var content = _react2.default.createElement(
          'div',
          { className: 'container card text-center login' },
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              'h4',
              { className: 'card-text' },
              'Log in with Facebook and stay safe during date nights!.'
            ),
            _react2.default.createElement('br', null),
            _react2.default.createElement(
              'a',
        ...
        var content = _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h4',
              { className: 'card-text' },
              'Create Profile or Create Date Night Alert'
            ),
            _react2.default.createElement('br', null),
            this.props.userComplete ? _react2.default.createElement(
              _reactRouterDom.Link,
              { to: '/dateCreation', className: 'btn btn-info create_btn' },
              'Create Date Alert'
            ) : _react2.default.createElement(
              'h6',
              null,
            ...
            _react2.default.createElement(
              _reactRouterDom.Link,
              { to: '/userCreation', className: 'btn btn-success create_btn' },
...
var UserCreation = function (_React$Component) {
  ...
  _createClass(UserCreation, [{
    ...
    value: function handleSubmit(event) {
      ...
      _axios2.default.put('/api/user/', newState).then(function (data) {
        if (data.data) {
          window.location = "/";
        } else {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Phone #:',
            _react2.default.createElement('input', { type: 'tel', placeholder: '+14151234567', onChange: function onChange(e) {
            ...
            _react2.default.createElement('br', null),
            'Height:',
            _react2.default.createElement('input', { type: 'text', placeholder: '5 feet 5 inches', onChange: function onChange(e) {
...
var DateCreation = function (_React$Component) {
  _inherits(DateCreation, _React$Component);

  function DateCreation(props) {
    _classCallCheck(this, DateCreation);

    var _this = _possibleConstructorReturn(this, (DateCreation.__proto__ || Object.getPrototypeOf(DateCreation)).call(this, props));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            'Date:',
            _react2.default.createElement('br', null),
            _react2.default.createElement('input', { id: 'date', type: 'date', onChange: function onChange(e) {
                return _this2.setState({ date: e.target.value });
              } }),
            _react2.default.createElement('br', null),
            'Time:',
            _react2.default.createElement('br', null),
            _react2.default.createElement('input', { id: 'time', type: 'time', onChange: function onChange(e) {
                return _this2.setState({ time: e.target.value });
              } }),
            'Address:',
            _react2.default.createElement('input', { id: 'address', type: 'text', onChange: function onChange(e) {
                return _this2.setState({ location: e.target.value });
              } }),
            'PhoneNumber:',
            _react2.default.createElement('br', null),
            _react2.default.createElement('input', { id: 'phoneNumber', type: 'text', onChange: function onChange(e) {
                return _this2.setState({ locationNumber: e.target.value });
              } })
          ),
          _react2.default.createElement('input', { type: 'submit', value: 'Submit' })
        )
